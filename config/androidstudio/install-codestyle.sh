...
echo "Installing Adevinta IntelliJ configs..."
...
echo "Done."
echo ""
echo "Restart IntelliJ and/or AndroidStudio, go to Preferences, Editor, Code Style, and select 'AdevintaAndroid' as scheme."
